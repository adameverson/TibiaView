...
local POTIONS = { 
        ...
        [8473] = {empty = 7635, splash = 2, health = {1450, 1500}, level = 130, vocations = {4, 8}, vocStr = "knights"}, -- ultimate health potion 
        [7620] = {empty = 7636, splash = 7, mana = {100, 200}}, -- mana potion 
        ...
        [8472] = {empty = 7635, splash = 3, health = {1300, 1360}, mana = {230, 380}, level = 80, vocations = {3, 7}, vocStr = "paladins"} -- great spirit potion 
} 
...
function onUse(cid, item, fromPosition, itemEx, toPosition) 
        ...
        if(not realAnimation) then 
                doCreatureSay(itemEx.uid, "|ROX|...", TALKTYPE_ORANGE_1) 
        else 
